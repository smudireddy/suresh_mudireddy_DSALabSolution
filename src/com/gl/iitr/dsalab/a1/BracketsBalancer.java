...
public class BracketsBalancer {
	...
	/*
	 * 
	 * Input String : ([{}]) Result : Has Balanced Brackets
	 * 
	 * Input String : [()]{}{[()()]()} Result : Has Balanced Brackets
	 * 
	 * Input String : [()]{}{[)()]()} Result : Do not contain Balanced Brackets
	 * 
	 * Input String : {{{{{{{[[[[[[]]]]]((((((()))))))}}}}}} Result : Do not contain
	 * Balanced Brackets
	 * 
	 * Input String : c{[(a)b]} Result : Has Balanced Brackets
	 * 
	 */
